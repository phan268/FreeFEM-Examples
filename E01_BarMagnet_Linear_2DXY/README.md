...
Deriving the weak formulation of the PDE is the very first step a researcher should take to use the available PDE solvers (like [FreeFEM](https://freefem.org/)) to solve PDEs.
