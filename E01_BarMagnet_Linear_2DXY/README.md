...
Deriving the weak formulation of the PDE is the very first step a researcher should take to use the available PDE solvers like [FreeFEM](https://freefem.org/) to simulate a mathematical model.
...
$$
\mathcal{V}=\lbrace{v(\mathbf{x}) | \mathbf{x} \in {\Omega}, v(\mathbf{x}) \in \mathcal{H}^{1}(\Omega), \text { and } v(\mathbf{x})=0 \text { on } \Gamma}\rbrace
$$
...
$$
\mathcal{S}_{t}=\lbrace{u(\mathbf{x}, t) | \mathbf{x} \in \Omega, t>0, u(\mathbf{x}, t) \in \mathcal{H}^{1}(\Omega), \text { and } \frac{\partial u}{\partial n}=0 \text { on } \Gamma}\rbrace.
$$
...
# Simulating a rectangular permanent magnet in 2D XY mode

The magnetization direction of the permanent magnet is defined by a variable $angle$, which is zero when the magnetization is oriented to +X direction. 

The flux line plot from postprocessing exported Az.vtu in ParaView is:

<div align="center">
<img src = "./images/Fluxlines.svg" alt = "flux line plot">
</div>

The mesh plot from postprocessing exported Az.vtu in ParaView is:

<div align="center">
<img src = "./images/Mesh.svg" alt = "flux line plot">
</div>

The vector plot of flux density from postprocessing exported Az.vtu in ParaView is:

<div align="center">
<img src = "./images/Vector_B.svg" alt = "flux line plot">
</div>

Az along the vertical line, which is perpendicular to the magnetization direction is:

<div align="center">
<img src = "./images/Az_Along_a_Line.png" alt = "flux line plot">
</div>

The magnitude of $B$ along the same vertical line from postprocessing exported Az.vtu in ParaView is:

<div align="center">
<img src = "./images/B_Along_a_Line.png" alt = "flux line plot">
</div>

Plots from native [FreeFem-cs](https://hal.science/hal-01169630/file/ffcs.pdf) are:

<div align="center">
<img src = "./images/Mesh_ffcs.png" alt = "flux line plot">
</div>

<div align="center">
<img src = "./images/Vector_B_ffcs.png" alt = "flux line plot">
</div>

<div align="center">
<img src = "./images/Az_ffcs.png" alt = "flux line plot">
</div>

<div align="center">
<img src = "./images/MagB_ffcs.png" alt = "flux line plot">
</div>

<div align="center">
<img src = "./images/Hc_ffcs.png" alt = "flux line plot">
</div>